...
#字体
mv $CURRENT_DIR/DIY/设置/advent_pro_extralight.ttf $CURRENT_DIR/$DIR/app/src/main/res/drawble/advent_pro_extralight.ttf
...
#播放界面微调
cp $CURRENT_DIR/DIY/设置/player_vod_control_view.xml $CURRENT_DIR/$DIR/app/src/main/res/layout/player_vod_control_view.xml
cp $CURRENT_DIR/DIY/设置/VodController.java $CURRENT_DIR/$DIR/app/src/main/java/com/github/tvbox/osc/player/controller/VodController.java
